...
export default async function ProjectPage({ params, searchParams }: Props) {
  ...
  const template = sellerName ? "مرحبًا أستاذ/ة {seller_name}، شاهدت مشروع {project_title} وأرغب في معرفة التفاصيل." : "مرحبًا، شاهدت مشروع {project_title} وأرغب في معرفة التفاصيل.";
