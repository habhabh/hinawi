...
type Seller = { name: string; jobTitle: string | null; bio: string | null; branch: string | null; avatarUrl: string | null; phoneE164: string | null; whatsappE164: string | null; customWhatsappMessage: string | null };
